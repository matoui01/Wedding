...
const I18N = {
  it:{
    ...
    "rsvp.who.h":"Accompagnatori e bambini","rsvp.who.plus":"Il vostro invito indica esattamente le persone per cui abbiamo tenuto un posto. Se menziona un accompagnatore, saremo felicissimi di conoscerlo: scriveteci il suo nome quando rispondete. Se non lo menziona, ci dispiace davvero — i tavoli della villa sono apparecchiati per un numero che non possiamo allargare.","rsvp.who.kids":"Con tutto l'affetto possibile, abbiamo deciso che sarà una festa per soli adulti. Vogliamo un gran bene ai vostri bambini: per questa volta speriamo possiate concedervi una serata tutta per voi. Se vi serve una babysitter a Firenze, chiedeteci pure — vi aiutiamo volentieri.",
  ...
  fr:{
    ...
    "rsvp.who.h":"Accompagnants et enfants","rsvp.who.plus":"Votre invitation nomme exactement les personnes pour qui nous avons gardé une place. Si elle mentionne un·e accompagnant·e, nous serons ravis de faire sa connaissance : indiquez-nous son nom en répondant. Si elle n'en mentionne pas, nous en sommes sincèrement désolés — les tables de la villa sont dressées pour un nombre que nous ne pouvons pas élargir.","rsvp.who.kids":"Avec toute la tendresse du monde, nous avons choisi une fête réservée aux adultes. Nous adorons vos enfants : pour cette fois, nous espérons que vous profiterez d'une soirée rien qu'à vous. Si vous cherchez une baby-sitter à Florence, demandez-nous — nous vous aiderons avec plaisir.",
