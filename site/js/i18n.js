...
const I18N = {
  it:{
    ...
    "day.dress.label":"Dress code","day.dress.value":"Cocktail elegante. Lo smoking non è obbligatorio — l'eleganza sì. Niente sneakers, niente pantaloncini, niente infradito. Il bianco, in ogni sua sfumatura, è della sposa.","day.dress.women":"Esempi di abiti da sera per le ospiti","day.dress.men":"Esempi di completi eleganti per gli ospiti","day.map.cap":"I giardini e la disposizione dei tavoli.",
  ...
  fr:{
    ...
    "day.dress.label":"Tenue","day.dress.value":"Cocktail élégant. Le smoking n'est pas obligatoire — l'élégance, elle, l'est. Ni baskets, ni shorts, ni tongs. Le blanc, dans toutes ses nuances, appartient à la mariée.","day.dress.women":"Exemples de tenues de soirée pour les invitées","day.dress.men":"Exemples de costumes élégants pour les invités","day.map.cap":"Les jardins et le plan de table.",
  ...
  en:{
    ...
    "day.dress.label":"Dress code","day.dress.value":"Elegant cocktail. Black tie is not required — elegance is. No sneakers, no shorts, no flip-flops. White, in all its shades, belongs to the bride.","day.dress.women":"Evening-wear inspiration for guests","day.dress.men":"Elegant suit inspiration for guests","day.map.cap":"The gardens and the seating plan.",
