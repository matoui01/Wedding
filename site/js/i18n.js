...
const I18N = {
  it:{
    ...
    "day.dress.label":"Dress code","day.dress.value":"Ai signori chiediamo cortesemente smoking o completo; alle signore un abito, una jumpsuit o un tailleur. Il bianco, in ogni sua sfumatura, è della sposa. Niente sneakers, niente infradito, niente pantaloncini.","day.dress.women":"Esempi di abiti da sera per le ospiti","day.dress.men":"Esempi di completi eleganti per gli ospiti","day.map.cap":"I giardini e la disposizione dei tavoli.",
  ...
  en:{
    ...
    "day.dress.label":"Dress code","day.dress.value":"Gentlemen are kindly asked to wear a tuxedo or a suit; ladies, a dress, a jumpsuit or a tailored suit. White, in all its shades, belongs to the bride. No sneakers, no flip-flops, no shorts.","day.dress.women":"Evening-wear inspiration for guests","day.dress.men":"Elegant suit inspiration for guests","day.map.cap":"The gardens and the seating plan.",
