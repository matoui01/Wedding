...
const I18N = {
  it:{
    ...
    "travel.car.h":"Transfer","travel.car.b":"Auto o taxi dal centro, ~25–30 min. La navetta da e per il centro di Firenze è ancora da confermare: segnalatecelo nel modulo RSVP se vi interessa un posto, e vi daremo i dettagli quando sapremo quanti siete.",
  ...
  fr:{
    ...
    "travel.car.h":"Transfert","travel.car.b":"Voiture ou taxi depuis le centre, ~25–30 min. La navette depuis et vers le centre de Florence reste à confirmer : dites-le-nous dans votre RSVP si une place vous intéresse, et nous vous donnerons les détails une fois que nous saurons combien vous êtes.",
  ...
  en:{
    ...
    "travel.car.h":"Getting to the villa","travel.car.b":"Car or taxi from the centre, ~25–30 min. A shuttle to and from central Florence is still to be confirmed: tell us in your RSVP if you would like a seat, and we will share the details once we know how many of you do.",
