...
const I18N = {
  it:{
    ...
    "day.dress.label":"Dress code","day.dress.value":"Cocktail elegante — vestitevi eleganti: niente sneakers, scarpe casual o pantaloncini. Il bianco, il beige e tutto ciò che vi somiglia sono riservati alla sposa.","day.dress.women":"Esempi di abiti da sera per le ospiti","day.dress.men":"Esempi di completi eleganti per gli ospiti","day.map.cap":"I giardini e la disposizione dei tavoli.",
  ...
  fr:{
    ...
    "day.dress.label":"Tenue","day.dress.value":"Cocktail élégant — mettez-vous sur votre trente-et-un : ni baskets, ni chaussures décontractées, ni shorts. Le blanc, le beige et tout ce qui s'en approche sont réservés à la mariée.","day.dress.women":"Exemples de tenues de soirée pour les invitées","day.dress.men":"Exemples de costumes élégants pour les invités","day.map.cap":"Les jardins et le plan de table.",
